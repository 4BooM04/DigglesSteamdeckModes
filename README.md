# Steamdeck supported mod manager for Diggles:Myth of Fenris

Extract everything from this folder to the root of the game.

This mod manager uses ugraded version of https://github.com/saibantes/Wiggles.RevisedPlanner.mod
